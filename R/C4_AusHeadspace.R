...
#' @import vicinity
#' @name AusHeadspace-class
#' @rdname AusHeadspace-class
#' @export AusHeadspace
#' @exportClass AusHeadspace
AusHeadspace <- methods::setClass("AusHeadspace",
...
methods::setValidity(methods::className("AusHeadspace"),
function(object){
msg <- NULL
