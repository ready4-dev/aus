...
#' @import vicinity
#' @name AusTasmania-class
#' @rdname AusTasmania-class
#' @export AusTasmania
#' @exportClass AusTasmania
AusTasmania <- methods::setClass("AusTasmania",
...
methods::setValidity(methods::className("AusTasmania"),
function(object){
msg <- NULL
