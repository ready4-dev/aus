...
## Model Australian Spatial Data with Ready4
...
[![R-CMD-check](https://github.com/ready4-dev/aus/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ready4-dev/aus/actions/workflows/R-CMD-check.yaml)
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.7687126.svg)](https://doi.org/10.5281/zenodo.7687126)
<!-- badges: end -->

Tools for modelling Australia specific geometry and spatial
attribute data for use with the ready4 youth mental health systems
model (https://ready4-dev.github.io/ready4/).  This development
version of the aus package has been made available as part of the
